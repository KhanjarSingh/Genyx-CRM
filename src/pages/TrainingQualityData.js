...
export const exerciseQualityData = [
  { rank: 1, name: 'Overhead Press', score: 78, members: 45, keyIssue: 'Minor shoulder path deviation', suggestion: 'Ideal standard maintained', status: 'good' },
  { rank: 2, name: 'Bench Press',    score: 71, members: 89, keyIssue: 'Scapular instability — 25% of sets', suggestion: 'Require shoulder warm-up', status: 'good' },
  { rank: 3, name: 'Lunge',          score: 66, members: 62, keyIssue: 'Lateral balance issues', suggestion: 'Introduce stability drills', status: 'ok' },
  { rank: 4, name: 'Barbell Row',    score: 58, members: 34, keyIssue: 'Lumbar flexion — 40% of sets', suggestion: 'Enforce core bracing', status: 'ok' },
  { rank: 5, name: 'Deadlift',       score: 55, members: 78, keyIssue: 'Hip hinge breakdown under fatigue', suggestion: 'Run hip hinge workshop', status: 'ok' },
  { rank: 6, name: 'Squat',          score: 45, members: 89, keyIssue: 'Knee valgus in 68% of reps', suggestion: 'Schedule mechanics clinic', status: 'bad' },
  { rank: 7, name: 'Leg Press',      score: 42, members: 56, keyIssue: 'Partial ROM — 72% of reps', suggestion: 'Standardize ROM targets', status: 'bad' },
];
