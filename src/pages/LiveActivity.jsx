...
const zones = [
  { id: 1, name: 'Free Weights', capacity: 40, current: 35, status: 'warning', cameras: 4 },
  { id: 2, name: 'Cardio Area', capacity: 50, current: 15, status: 'success', cameras: 6 },
  { id: 3, name: 'Functional Training', capacity: 20, current: 22, status: 'destructive', cameras: 2 },
  { id: 4, name: 'Studio A (Yoga)', capacity: 30, current: 0, status: 'default', cameras: 1 },
];
            ...
            <CardContent>
              <div className="flex items-center justify-between mt-4">
                <div className="flex items-center text-sm text-gray-500">
                  ...
                  <span className="font-medium text-gray-900">{zone.current}</span>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex gap-4 p-3 rounded-lg border border-red-100 bg-red-50/50">
              <div className="mt-1">
              ...
              <div>
                <h4 className="text-sm font-semibold text-gray-900">Form Correction Needed: Deadlift</h4>
                <p className="mt-1 text-xs text-gray-600">Rahul on Deadlift Platform A is showing high-risk lower back curvature.</p>
                <div className="mt-2 flex items-center gap-2">
                  <Badge variant="destructive">2 mins ago</Badge>
                  <button className="text-xs font-medium text-red-600 hover:text-red-700 flex items-center">
            ...
            <div className="flex gap-4 p-3 rounded-lg border border-emerald-100 bg-emerald-50/50">
              <div className="mt-1">
                <span className="relative flex h-3 w-3">
              ...
              <div>
                <h4 className="text-sm font-semibold text-gray-900">Potential PT Lead: Squats</h4>
                <p className="mt-1 text-xs text-gray-600">Aditya has been struggling with Squat depth for the 3rd consecutive session.</p>
                <div className="mt-2 flex items-center gap-2">
